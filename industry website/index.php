            ...
            <div class="carousel-item carousel-image-1 active">
                <div class="container">
                    <div class="carousel-caption d-none d-sm-block text-left mb-5">
                        <h3 class="display-3">GLOZZOM</h3>
                        <p class="lead">WE AT GLOZZOM PROVIDE MANY SERVICES AND PRODUCTS, CLICK ON THE BELOW SIGN UP BUTTON TO CREATE YOUR GLOZZOM ACCOUNT.</p>
            ...
            <div class="carousel-item carousel-image-2">
                <div class="container">
                    <div class="carousel-caption d-none d-sm-block mb-5">
                        <h3 class="display-3">GLOZZOM</h3>
                        <p class="lead">TO KNOW MORE ABOUT GLOZZOM CLICK ON THE LEARN MORE BUTTON BELOW.</p>
            ...
            <div class="carousel-item carousel-image-3">
                <div class="container">
                    <div class="carousel-caption d-none d-sm-block text-right mb-5">
                        <h3 class="display-3">GLOZZOM</h3>
                        <p class="lead">FOR MORE INFORMATION ABOUT GLOZZOM CLICK BELOW.</p>
                        <a href="about.html" class="btn btn-success btn-lg">Read More</a>
                    </div>
                </div>
            </div>
          </div>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-4 mb-4 text-center">
                 ...
                 <h3>Turning Gears</h3>
                 <p>Gears are mechanisms that mesh together via teeth and are used to transmit rotary motion from one shaft to another.</p>
              </div>
              <div class="col-md-4 mb-4 text-center">
                 <i class="fas fa-cloud fa-3x mb-2"></i> 
                 <h3>Sending Data</h3>
                 <p>An HTML form on a web page is nothing more than a convenient user-friendly way to configure an HTTP request to send data to a server.</p>
              </div>
              <div class="col-md-4 mb-4 text-center">
                 <i class="fas fa-cart-plus fa-3x mb-2"></i> 
                 <h3>Making Money</h3>
                 <p>Looking for proven ways to make money online?</p>
              </div>
          </div>
      </div>
  </section>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 align-self-center">
                  <h3>WHAT DO WE DO? </h3>
                  <p>Glozzom Inc. is an indian multinational e-commerce company headquartered in Bangalore, Karnataka. It is also the name of its proprietary e-commerce platform for online stores and retail point-of-sale systems.</p>
                  <a href="about.html" class="btn btn-lg btn-outline-danger">Learn More</a>
              </div>
              <div class="col-md-6">
          ...
          <div class="row">
              <div class="col">
                  <div class="container p-5">
                      <a href="#" class="video" data-video="https://www.youtube.com/embed/EDleqidmsXA" data-toggle="modal" data-target="#videoModal">
      ...
      <div class="container">
          <div class="row">
              <div class="col">
                  ...
                  <p>Fill the sign up form below to get our daily newsletter about the new updates we provide.</p>
                  <form action="" class="justify-content-center">
                      ...
                      <button class="btn btn-primary btn-block mb-2">Submit</button>
                  </form>
              </div>
          </div>
      </div>
      ...
      <div class="container">
          <div class="row">
              <div class="col">
                  ...
                  <p class="lead">Thank you for visitng our website!</p>
              </div>
          </div>
      </div>
  </footer>
